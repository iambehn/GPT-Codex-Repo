...
| Happy Path Operator Pack | [operator_pack/README.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/operator_pack/README.md) | Active execution-control files for the first runnable happy path, including the live autonomy snapshot, phase backlog, blockers, failure seeds, routine run logging, and bounded Codex heartbeat automation policy | Stable subsystem theory or duplicate architecture prose |
...
| Researcher Interaction Routing | [INTERACTION_ROUTING.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/INTERACTION_ROUTING.md) | Internal researcher routing logic, target-artifact selection, checkpoint cards, weakest-blocker questioning, anti-premature-tasking rules | Packet field schema, backlog queue mechanics, or runtime pipeline routing |
| Research Packet And Backlog Inputs | [RESEARCHER_INPUT_CONTRACT.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/RESEARCHER_INPUT_CONTRACT.md), [RESEARCH_PACKET_TEMPLATE.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/RESEARCH_PACKET_TEMPLATE.md), and [BACKLOG_OPERATING_MODEL.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/BACKLOG_OPERATING_MODEL.md) | Researcher-to-Codex input contract, handoff shape, backlog readiness rules, decision-ready task structure | Runtime semantics, published-pack rules, or duplicate operator-pack status |
...
| Archive / Raw Notes | [archive/RAW_NOTES_CATALOG.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/archive/RAW_NOTES_CATALOG.md), [archive/CONVERSATION_ARCHIVE_POLICY.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/archive/CONVERSATION_ARCHIVE_POLICY.md), and companion archive docs | Traceability back to Drive notes, older planning artifacts, and historical conversation preservation rules | Day-to-day execution-control truth |
...
- If it answers "what is the current first happy path, what blocks it, what phase backlog should Codex execute next, what is the next state transition, or where should routine in-progress execution notes live?", put it in [operator_pack/README.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/operator_pack/README.md) and its companion files.
- If it answers "how should recurring Codex heartbeat automation stay bounded inside existing execution-control surfaces?", put it in the operator-pack companion automation policy/prompt docs.
- If it answers "how should the repo shape research-agent outputs and tool roles?", put it in the research-agent framework doc.
- If it answers "how should the researcher GPT choose the next interaction move or artifact target before emitting an external handoff?", put it in [INTERACTION_ROUTING.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/INTERACTION_ROUTING.md).
- If it answers "what exact format should a researcher hand to Codex?", "what level of packet detail keeps Codex autonomous?", or "how should the backlog stay full of actionable work?", put it in [RESEARCHER_INPUT_CONTRACT.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/RESEARCHER_INPUT_CONTRACT.md), [RESEARCH_PACKET_TEMPLATE.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/RESEARCH_PACKET_TEMPLATE.md), and [BACKLOG_OPERATING_MODEL.md](/Users/tj/Documents/Codex/2026-04-21-https-github-com-iambehn-claude-repo/docs/v2/BACKLOG_OPERATING_MODEL.md).
...
- If it answers "how should completed conversations be preserved historically, batched, and published into Drive without becoming live execution state?", put it in the archive companion conversation-archive docs.
