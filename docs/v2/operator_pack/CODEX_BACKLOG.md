...
- avoid spending more slices on random clip hunting alone until medal-specific pack coverage improves; the current cross-clip measurement already shows the same structural ceiling across four samples
- current next target:
