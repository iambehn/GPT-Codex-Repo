...
def _resolve_output_path(*, output_path: str | Path | None) -> Path:
    return _artifact_resolve_timestamped_output_path(
        ...
        default_dir=DEFAULT_OUTPUT_ROOT / "cross_game_analysis" / "history" / "summary",
        filename_suffix="detector_calibration_next_action_cross_game_ledger_comparison_history_summary.json",
